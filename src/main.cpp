...
void exe_simple_pendulum(){
    ...
    double final_time = 2; // Temps final en secondes
    ...
    double dphi0 = -0.5;         // Vitesse angulaire azimutale initiale
...
void exe_double_pendulum(){
    ...
    double time_step = 0.001;  // Pas de temps en secondes
    double final_time = 100; // Temps final en secondes
    ...
    double q2 = -0.5;   // Coordonnée stéréographique du premier pendule
    double q3 = 0.5;   // Coordonnée stéréographique du second pendule
    double q4 = 0.0;   // Coordonnée stéréographique du second pendule
    double p1 = 0.5;   // Impulsion stéréographique du premier pendule
